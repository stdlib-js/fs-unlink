...
```javascript
import unlink from 'https://cdn.jsdelivr.net/gh/stdlib-js/fs-unlink@v0.1.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { sync } from 'https://cdn.jsdelivr.net/gh/stdlib-js/fs-unlink@v0.1.1-esm/index.mjs';
```
